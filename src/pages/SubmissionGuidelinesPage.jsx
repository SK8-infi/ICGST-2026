                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
                            ...
                            <div className="space-y-3">
                                <a href="https://cmt3.research.microsoft.com/ICGST2026/Submission/Index" target="_blank" rel="noopener noreferrer" className="block w-full text-center py-2 px-4 bg-[#002855] !text-white rounded-lg font-bold hover:bg-[#001a3a] transition-colors shadow-md">
                    ...
                    <div
                        ...
                        dangerouslySetInnerHTML={{
                            __html: '<p style="text-align:center;font-size:1.2rem;color:#64748b;line-height:1.6;margin:0;"><strong>CMT ACKNOWLEDGMENT:</strong> The Microsoft CMT service was used for managing the peer-reviewing process for this conference. This service was provided for free by Microsoft, and they bore all expenses, including costs for Azure cloud services as well as for software development and support.</p>'
                        }}
                    />
