    ...
    return (
        <div className="bg-neutral-50 pb-16 min-h-screen">
            ...
            <HeroSection
                ...
                subtitle="Join our esteemed Reviewer Panel for ICGST-2026."
            />
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 overflow-hidden">
                        <div className="bg-[#002855] px-6 py-8 text-center">
                            ...
                            <p className="text-blue-100 text-lg">(Join our Reviewer Panel)</p>
                        </div>
                        ...
                        <div className="px-6 py-8 sm:p-10">
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-neutral-900 mb-1">Who can apply?</h3>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-neutral-900 mb-1">Benefits and Recognition</h3>
                                        <p className="text-neutral-600 text-base leading-relaxed">
                            ...
                            <div className="flex flex-col items-center">
                                <h3 className="text-lg font-bold text-neutral-900 mb-4 flex items-center justify-center gap-2">
                                   <span className="text-2xl">👉</span> Apply via Google Form
                                </h3>
                                <a 
                                    href="https://forms.gle/MncU6Pxa2GuY5bpP8" 
                                    target="_blank" 
                                ...
                                <p className="mt-4 text-sm text-neutral-500 font-medium break-all">
                                    https://forms.gle/MncU6Pxa2GuY5bpP8
                                </p>
                            </div>
                        </div>
                    </div>
