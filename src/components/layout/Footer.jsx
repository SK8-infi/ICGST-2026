            ...
            <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
                    ...
                    <div className="flex flex-col items-center md:items-start space-y-4 w-full">
                        <h4 className="text-base font-bold tracking-wide uppercase !text-white drop-shadow-sm border-b-2 border-[#4da6ff]/50 pb-1 mb-2">
                            Quick Links
                        </h4>
                        <ul className="space-y-2 text-sm text-center md:text-left">
                            <li>
                                <Link to="/" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Home
                                </Link>
                            </li>
                            <li>
                                <Link to="/about" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    About ICGST
                                </Link>
                            </li>
                            <li>
                                <Link to="/call-for-papers/tracks" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Call for Papers
                                </Link>
                            </li>
                            <li>
                                <Link to="/dates" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Important Dates
                                </Link>
                            </li>
                            <li>
                                <Link to="/committee" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Committee
                                </Link>
                            </li>
                            <li>
                                <Link to="/contact" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Contact Us
                                </Link>
                            </li>
                            <li>
                                <Link to="/travel/visa" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Travel Visa
                                </Link>
                            </li>
                            <li>
                                <Link to="/travel/venue" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Venue & Directions
                                </Link>
                            </li>
                            <li>
                                <Link to="/travel/explore-gwalior" className="!text-white hover:text-[#4da6ff] transition-colors flex items-center gap-2 justify-center md:justify-start group">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[#4da6ff] opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                    Explore Gwalior
                                </Link>
                            </li>
